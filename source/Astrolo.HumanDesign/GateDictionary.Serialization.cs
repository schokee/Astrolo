    ...
    public static GateDictionary Create()
    {
        ...
        foreach (var pair in channels)
        {
            ...
            foreach (var info in pair)
            {
                ...
                {
                    gate = new(hexagramLookup[info.Number], info.Gate!, info.Center, info.Circuit, lineLookup[info.Number]);
    ...
    private static class Serialization
    {
        ...
        public class LineRecord
        {
            ...
            public MandalaSlice ToLocation()
            {
                ...
                return new(Sign, startAngle, SweepAngle);
            }
