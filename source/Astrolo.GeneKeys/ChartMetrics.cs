...
namespace Astrolo.GeneKeys
{
    public sealed class ChartMetrics
    {
        ...
        private static IEnumerable<Sphere> TraversePathway(Pathway pathway)
        {
            ...
            {
                Pathway.Challenge => new[] { Sphere.LifesWork, Sphere.Evolution },
                Pathway.Breakthrough => new[] { Sphere.Evolution, Sphere.Radiance },
                Pathway.CoreStability => new[] { Sphere.Radiance, Sphere.Purpose },
                Pathway.Dharma => new[] { Sphere.Purpose, Sphere.Attraction },
                Pathway.Karma => new[] { Sphere.Attraction, Sphere.IQ },
                Pathway.Intelligence => new[] { Sphere.IQ, Sphere.EQ },
                Pathway.Love => new[] { Sphere.EQ, Sphere.SQ },
                Pathway.Realisation => new[] { Sphere.SQ, Sphere.Vocation },
                Pathway.Initiative => new[] { Sphere.Vocation, Sphere.Culture },
                Pathway.Growth => new[] { Sphere.Culture, Sphere.LifesWork },
                Pathway.Service => new[] { Sphere.LifesWork, Sphere.Vocation },
